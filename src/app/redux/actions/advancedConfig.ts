...
export const actionTypes = {
  ...
  SET_DEBUGGING_VARIABLES: '@ADVANCED_CONFIG/SET_DEBUGGING_VARIABLES',
...
export const setDebuggingVariables = makeActionCreator(
  actionTypes.SET_DEBUGGING_VARIABLES,
  'arg'
);
