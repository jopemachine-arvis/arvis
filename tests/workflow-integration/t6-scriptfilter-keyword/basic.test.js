...
describe('Integration test', function () {
  ...
  it('Test 6 - scriptfilter + keyword', async function () {
    ...
    assert.strictEqual(itemTitle2, 'Test 6 - scriptfilter + keyword, result 1');

    robot.keyTap('enter');

    await sleep(500);

    assert.strictEqual(await app.electron.clipboard.readText(), 'Test 6 - scriptfilter + keyword, result 2');
  });
});
